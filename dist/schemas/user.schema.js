...
var Role;
(function (Role) {
    Role[Role["OrganizationLeader"] = 0] = "OrganizationLeader";
    Role[Role["Caretaker"] = 1] = "Caretaker";
    Role[Role["Volunteer"] = 2] = "Volunteer";
...
], User.prototype, "colonies", void 0);
__decorate([
...
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: Role }),
